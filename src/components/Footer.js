...
const Footer = ()=> {
    ...
    <li> <Link  to="/" style={{color:"white",textDecoration:"none"}}>Review</Link></li>
       ...
       <br/>
         ...
         <li style={{color:"white",textDecoration:"none"}}> <i className="fa fa-phone-square" ></i> 0120 242 3303</li><br/>
         <li style={{color:"white",textDecoration:"none"}} > <i className="far fa-envelope"></i> oak.work4you@gmail.com</li><br/>
       <li style={{color:"white",textDecoration:"none"}}><i className="fas fa-map-marker-alt" ></i> D-1 Sector-1,<br/>Noida, Uttar Pradesh<br/> 201301</li><br/>
        </ul>
      ...
      © Copyright 2024, oak.work4you@gmail.com
      </div>
