                    ...
                    <div className="row card-5" style={{ margin: "0rem 2rem 0rem 2rem", padding: "2rem 2rem 2rem 2rem" }}>
                        <div className="col-md-6 col-lg-6">
                            ...
                            <form method="POST">
                                ...
                                <button type="submit" className="btn btn-dark" id="signin" onClick={loginAdmin} style={{ marginTop: "2rem" }}>Login</button>
                            </form>
                        </div>
                        <div className="col-md-6 col-lg-6" style={{ padding: "4rem 4rem 4rem 4rem" }}>
                            ...
                            <center>
                                <Link to="/registerlogin" style={{ textDecoration: "none" }}>Create an account</Link>
                            </center>
                        </div>
                    </div>
                </div>
